...
class ParticleTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        _logger.info(
            'KAN FFN settings: main=%s, cls=%s, num_grids=%s, grid_range=%s, base_activation=%s',
        ...
        if fc_params is not None:
            ...
            if use_kan_head:
                _logger.info(
                    ...
                    kan_head_num_grids, str(kan_head_grid_range), kan_head_base_activation)
                self.fc = KANClassificationHead(
                    input_dim=embed_dim,
